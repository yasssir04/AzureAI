...
def main():
    ...
    try:
        ...
        Upload_Images('images')#'images' is the folder containing the images in local file
...
def Upload_Images(folder):
    ...
    with open('tagged-images.json', 'r') as json_file:#'tagged-images.json' contains the tagged reagion of each image(includes name tag, cordinates,dimentions of the bounding box of the tagged region)
